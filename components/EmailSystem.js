...
export default function EmailSystem() {
  ...
  if (loading || !currentUser) return <View style={[styles.childContainer, {justifyContent:'center', alignItems:'center'}]}><ActivityIndicator size="large" color="#01579b" /></View>;
        ...
        <View style={styles.menuOverlay}>
          ...
          <View style={styles.menuContent}>
            <View style={styles.menuHeader}>
              <View style={[styles.menuAvatar, {backgroundColor: '#01579b'}]}><Text style={styles.menuAvatarText}>{currentUser.display_name[0].toUpperCase()}</Text></View>
        ...
        <KeyboardAvoidingView style={styles.mainView} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          <View style={styles.header}>
            <TouchableOpacity onPress={() => setSelectedThread(null)} style={styles.backBtn}>
              <Ionicons name="chevron-back" size={24} color="#01579b" />
      ...
      <Modal visible={composeOpen} animationType="slide" presentationStyle="formSheet">
        <View style={styles.modalContainer}>
            <View style={styles.modalHeader}>
                <TouchableOpacity onPress={() => setComposeOpen(false)}><Text style={styles.cancelText}>Cancel</Text></TouchableOpacity>
                <Text style={styles.modalTitle}>New Message</Text>
                <TouchableOpacity onPress={handleSendNew}><Text style={styles.sendText}>Send</Text></TouchableOpacity>
            </View>
...
const styles = StyleSheet.create({
  ...
  menuAvatar: { width: 60, height: 60, borderRadius: 30, backgroundColor: '#01579b', justifyContent: 'center', alignItems: 'center', marginBottom: 12 },
  ...
  composeBtn: { backgroundColor: '#01579b', padding: 8, borderRadius: 20, width: 40, height: 40, alignItems: 'center', justifyContent: 'center' },
  backBtn: { flexDirection: 'row', alignItems: 'center', width: 80 },
  backBtnText: { color: '#01579b', fontSize: 16, marginLeft: 4 },
  ...
  threadUnread: { borderColor: '#01579b', backgroundColor: '#121a22' },
  ...
  unreadDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#01579b', marginLeft: 10 },
  ...
  sendBtn: { backgroundColor: '#01579b', width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center', marginLeft: 8 },
  modalContainer: { flex: 1, backgroundColor: '#0b0b0c', paddingTop: Platform.OS === 'android' ? 40 : 0 },
  modalHeader: { flexDirection: 'row', justifyContent: 'space-between', padding: 16, borderBottomWidth: 1, borderColor: '#1f1f24', backgroundColor: '#141418' },
